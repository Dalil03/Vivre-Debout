...
import Atelier from "../public/conte.jpg";
...
function Home() {
  ...
  useEffect(() => {
    document.getElementById("root").style.backgroundColor = "#F3FFF5";
    const handleResize = () => {
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        >
          ...
          <ModalBody>
            ...
            <Image h={'20vh'} m={"auto"} src={images[currentImageIndex]} alt={header} />
            {body && <Text fontSize={"1.15rem"} mt="3.5rem">{body}</Text>}
          </ModalBody>
          <ModalFooter>
            <Button onClick={onClose} color="white" _hover={{ bg: "#42BB56" }} backgroundColor="#68E67D">
              Fermer
            </Button>
          </ModalFooter>
        </ModalContent>
    ...
    <Box >
      <img src="/pch-logo.jpg" alt="Image 3"  width={"100%"} />
        ...
        <Grid
          ...
          templateRows="auto"
          pos="relative"
          top={{ base: "2rem", sm: "4rem", md: "4rem", lg: "10", xl: "4rem" }}
          left={{lg:'20%'}}
          rowGap="3rem"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Flex  gap={{lg:"5",base:"5rem"}} pos={"relative"} display="flex" flexDirection={{base:"column",md:"row"}} alignItems="center">
...
<CustomImageModal
  ...
  onClose={onSortiesClose}
  header="Sorties"
  body="les sorties régulières sont une composante essentielle des programmes de notre  association. Elles offrent des bénéfices significatifs sur le plan personnel, social et communautaire, tout en contribuant à une société plus inclusive et solidaire."
  images={[sortieP]}
